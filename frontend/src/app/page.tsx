      ...
      <main className="relative z-10 flex flex-col flex-1 items-center justify-center px-6 text-center mt-[-80px]">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <Link
            ...
            target="_blank"
            className="flex items-center justify-center h-14 px-8 rounded-full bg-white/5 text-white font-semibold text-lg border border-white/10 hover:bg-white/10 transition-all backdrop-blur-sm gap-2"
          >
